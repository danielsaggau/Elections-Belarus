...
colnames(data)[8:20] = c("total","received", "took_part", "took_part_early","took_part_residence","electionday", "vote_dropped_out","against_all","against_onecandiate", "invalid", "commission", "spoiled", " unused")
